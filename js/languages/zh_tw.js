...
(function (global, factory) {
  ...
  FE.LANGUAGE['zh_tw'] = {
    translation: {
      ...
      'Face with stuck out tongue': '舌头伸出来的臉',
      'Face with stuck out tongue and winking eye': '眨眼吐舌\'',
      'Face with stuck out tongue and tightly-closed eyes': '脸上伸出舌頭和眨眼的眼睛',
      ...
      'Face with look of triumph': '胜利的臉',
      'Disappointed but relieved face': '失望但釋然的臉',
      ...
      // Word Paste.
      'The pasted content is coming from a Microsoft Word document. Do you want to keep the format or clean it up?': '貼上的內容來自微軟Word文檔。你想保留格式還是清理它？',
      'Keep': '保留',
      'Clean': '清除',
